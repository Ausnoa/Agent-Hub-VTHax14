...
export default function LoginPage(){
  ...
  return <PageShell narrow><PageHeader eyebrow="YOUR AGENT WORKSPACE" title={signup?'Create your account':'Welcome back'} description="Save your agents, test them, and keep your results in one private workspace."/>
