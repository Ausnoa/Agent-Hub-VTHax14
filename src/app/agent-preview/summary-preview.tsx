...
export default function SummaryPreview({ enabled }: { enabled: boolean }) {
  ...
  return <main className="brief-preview">
    ...
    </div><footer className="brief-footer"><span>Supplied text only · No invented tasks · Review important details</span><Link href="/.well-known/agent-card.json">View A2A agent card ↗</Link></footer>
  </main>;
}
