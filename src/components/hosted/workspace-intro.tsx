  ...
  return <section className="atelier-workspace" aria-labelledby="atelier-title">
    <aside className="atelier-rail">
      ...
      <nav aria-label="Workspace shortcuts">
        ...
        <Link href="/create"><GitBranch size={16}/> Workflow composer <ArrowUpRight size={12}/></Link>
    ...
    <div className="atelier-hero">
      ...
      <div className="atelier-actions"><Link className="btn btn-primary" href="/agent-preview"><Plus size={16}/> Create an agent</Link><Link className="btn btn-secondary" href="/create"><GitBranch size={16}/> Compose workflow</Link></div>
