...
export default function WorkspaceAccess({ children }: { children: ReactNode }) {
  ...
  if (["/create", "/studio", "/agent-preview", "/login", "/dashboard", "/execution"].includes(pathname) || pathname.startsWith("/profile/")) return children;
  ...
  if (pathname === "/general") return <WorkflowPages mode="compose"/>;
